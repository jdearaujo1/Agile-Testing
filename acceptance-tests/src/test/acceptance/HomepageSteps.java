...
public class HomepageSteps {
    ...
    @When("^je clic sur le bouton \"([^\"]*)\"$")
        driver.findElement(By.cssSelector("._cookieBanner-module_cookieBanner-continueBtn__1tjvs")).click();
        Thread.sleep(2000);
        driver.findElement(By.cssSelector(".e2e-guest-home-page-groups-near-you a.exploreHome-section-showMore")).click();
        //throw new PendingException();
    }
